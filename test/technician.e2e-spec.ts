...
import { SpecialistUserModule } from '../src/modules/user/specialist/specialist-user.module';
...
describe('TechnicianController (e2e)', () => {
  ...
  beforeAll(async () => {
    const moduleFixture = await Test.createTestingModule({
      imports: [TypeOrmModule.forRoot(require('./ormconfig')), CoreModule, AuthModule, SpecialistUserModule],
    }).compile();
  ...
  const endpoint = '/user/specialist';
